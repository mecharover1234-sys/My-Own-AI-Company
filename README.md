...
### 🔴 채찍 모드 (Whip Mode)
AI 응답이 너무 길다 싶을 때 사용하는 특별 기능입니다.  
채찍 모드 ON 상태에서 `Space`를 누르고 마우스를 빠르게 휘두르면 채찍 소리와 함께 연구원들을 재촉합니다.
...
> ⚠️ Claude 계정이 필요합니다. 앱 실행 전 반드시 로그인하세요.
...
3. 연구원들이 순서대로 응답 — 픽셀 캐릭터가 책상으로 이동하며 타이핑
